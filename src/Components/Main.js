...
import form from '../images/resumeBuilderForm.png';
import output from '../images/resumeOutput.png';
import cycles from '../images/viciousCyclesWebsite.png';
                ...
                <div id="previousAnchor">
                    ...
                    <ul style={{listStyleType: "none"}}>
                        <div>
                            ...
                            <img src={form} alt="resume builder form" style={{height: "400px", marginRight: "10px"}}></img>
                            <img src={output} alt="Resume Output" style={{height: "400px"}}></img>
                        </div>
                        <div>
                            ...
                            <img src={cycles} alt="Vicious Cycles Homepage" style={{height: "400px"}}></img>
                        </div>
                        <div>
